...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('smart_bloger_category_post')) {
            $table = $installer->getConnection()->newTable(
                $installer->getTable('smart_bloger_category_post')
            )
                ->addColumn(
                    'categorypost_id',
                    \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
        ...
        if (!$installer->tableExists('smart_bloger_post_product')) {
            $table = $installer->getConnection()->newTable(
                $installer->getTable('smart_bloger_post_product')
            )
                ->addColumn(
                    'postproduct_id',
                    \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
