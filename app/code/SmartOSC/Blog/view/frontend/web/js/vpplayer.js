...
(function($) {
	...
	function cP() {
        ...
        h.c.trkscrl2 = h.d("div", {
            a : "id",
            v : "trackName"
        },(h.preloadMessage != undefined)?h.preloadMessage:"LOADING",undefined);
		h.c.tn.appendChild(h.c.trkscrl);
		h.c.tn.appendChild(h.c.trkscrl2);
		...
		var interval = setInterval(
				function() {
						...
						if(!isNaN(h.c.a.duration)){
							...
							h.c.trkscrl.innerHTML = h.trackTitle;
							h.c.trkscrl2.innerHTML = h.trackName;
							h.c.vpre = (h.c.vr.value/100);
							h.c.vrpre = h.c.vr.value;
							h.c.rpfl = 0;
						} else {
							h.c.trkscrl.innerHTML = "Untitled Track";
							h.c.trkscrl2.innerHTML = "Untitled Track";
						}
